...
import { addCrop,updateCrop,deleteCrop,getFarmerOrders,getFarmerCrops } from "../controllers/farmers.controller.js";
...
router.route('/get-farmer-crops').get(verifyJWT,getFarmerCrops);
